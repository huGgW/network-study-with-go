...
type Rosie struct {
	...
	housework.UnimplementedRobotMaidServer // forward compatible로 인해 반드시 포함해야 함
}

func (r *Rosie) Add(
	_ context.Context, chores *housework.Chores,
) (
...
func (r *Rosie) Complete(
	_ context.Context, req *housework.CompleteRequest,
) (
	*housework.Response, error,
) {
	r.mu.Lock()
