...
import (
	...
	// "github.com/huGgW/network-study-with-go/ch12/housework"
	// storage "github.com/huGgW/network-study-with-go/ch12/json"
	// storage "github.com/huGgW/network-study-with-go/ch12/gob"

	"github.com/huGgW/network-study-with-go/ch12/housework/v1"
	storage "github.com/huGgW/network-study-with-go/ch12/protobuf"
)
...
Usage: %s [flags] [add chore, ...|complete #]
    add: add comma-seperated chores
