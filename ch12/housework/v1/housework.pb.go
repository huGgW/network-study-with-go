...
type Chores struct {
	...
	Chores []*Chore `protobuf:"bytes,1,rep,name=chores,proto3" json:"chores,omitempty"` // repeated: 여러 개의 원소를 포함함을 정의
}
...
var file_housework_v1_housework_proto_rawDesc = []byte{
	...
	0x75, 0x47, 0x67, 0x57, 0x2f, 0x6e, 0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b, 0x2d, 0x73, 0x74, 0x75,
	0x64, 0x79, 0x2d, 0x77, 0x69, 0x74, 0x68, 0x2d, 0x67, 0x6f, 0x2f, 0x63, 0x68, 0x31, 0x32, 0x2f,
	0x68, 0x6f, 0x75, 0x73, 0x65, 0x77, 0x6f, 0x72, 0x6b, 0x2f, 0x76, 0x31, 0x2f, 0x68, 0x6f, 0x75,
	0x73, 0x65, 0x77, 0x6f, 0x72, 0x6b, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
func file_housework_v1_housework_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_housework_v1_housework_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_housework_v1_housework_proto_msgTypes[3].Exporter = func(v any, i int) any {
			switch v := v.(*Empty); i {
			case 0:
				return &v.state
			case 1:
		...
		file_housework_v1_housework_proto_msgTypes[4].Exporter = func(v any, i int) any {
